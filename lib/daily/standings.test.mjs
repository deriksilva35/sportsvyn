...
test('the standings row carries no per-day detail that could name today', () => {
  ...
  // 'best' joined the set for the league page's season chip (mock v0_1) -
  // it is a TIER LABEL, an aggregate like hof/mvp, and names no day.
  assert.deepEqual(Object.keys(t[0]).sort(),
    ['best', 'daysPlayable', 'handle', 'hof', 'mvp', 'pct', 'pctSum', 'played', 'points', 'rank', 'userId']);
