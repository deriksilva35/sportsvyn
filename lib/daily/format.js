...
//   - NO CEILING, NO PERCENTAGE. Zero, negative, non-finite and missing are
//     ONE ANSWER (ruled): null, and the caller omits the line. Never a dash,
//     never "0%" - "0%" is a claim about a score, and a board with no ceiling
//     gives us no score to make it about. Nothing divides by zero because the
//     guard returns above the division.
 ...
 *   ceiling to measure against or no score to measure, in which case the
