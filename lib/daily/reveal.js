 ...
 * clock to anyone who abandons the first would make the three minutes optional -
...
/**
 * The tier badge's colour class, per Design Tokens v1.2 s3: colour carries
 * rank - volt top, jade second, paper mid, terra bottom.
 *
 * v1.2 names FOUR colours for FIVE tiers. STARTER is the interpolation: the
 * rung between mid and bottom is muted rather than a new hue, because adding a
 * fifth colour to a four-colour ramp is a design decision, not a build one.
 */
export const TIER_CLASS = {
  'HALL OF FAME': 'tier--hof',
  MVP: 'tier--mvp',
  'PRO BOWLER': 'tier--pb',
  STARTER: 'tier--st',
  'PRACTICE SQUAD': 'tier--ps',
};
export const tierClass = (label) => TIER_CLASS[label] ?? 'tier--pb';
