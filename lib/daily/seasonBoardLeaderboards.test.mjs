...
// THE SHAPE THE FIXTURE'S BOARD IS WRITTEN UNDER (migrations/103). Stated
// here rather than imported: a fixture that follows the live constant
// would silently change shape the next time the ranked board does, which
// is exactly what the column exists to prevent.
