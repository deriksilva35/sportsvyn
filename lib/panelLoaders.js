...
import {
  ContestsPanel, PickemPanel, FantasyPanel, TodayNextPanel, LiveNowPanel,
  RankingsPanel, SchedulePanel, YourPlayersPanel,
...
export const PANEL_BINDINGS = {
  ...
  schedule: {
    ...
    load: async (_ids, ctx) => ({ games: await myFollowedTeamNext(ctx?.userId) }),
  },
  players: {
