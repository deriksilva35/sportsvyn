...
export async function bridgeRoster(draftId, userId) {
  ...
  //
  // THE ROLLING POOL MAKES IT REACHABLE HONESTLY. A room that straddles the
  // week's first kickoff can run out of candidates and end short, and the rule
  // is that such a roster scores what it drafted. The two look identical from
