...
// THERE IS NO BURN READ HERE ANY MORE. usedPlayers() lived at this spot and is
// deleted with the rule: October is a fresh five every day, so nothing in this
// module consults a prior entry, and A TEST PINS THAT (october/pool.test.mjs).
// The Run's own usedPlayers() in lib/run/pool.js is untouched - that game still
// spends its players, and migration 112's index still serves it.
