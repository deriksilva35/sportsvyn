 ...
 */
// 'tracker' is the secondary link, which routes to TrackerStart rather than
// buying anything. 'purchase' is GONE: the sheet no longer carries a buy
// control, so keeping the token would describe something that cannot happen -
// and no row ever carried it, the ledger having shipped with zero traffic.
export const DISMISS_CONTROLS = ['primary', 'tracker', 'backdrop', 'escape'];
