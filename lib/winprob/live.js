...
/**
 * The newest play with a known offense - kickoffs and PATs included; their
 * missing down/distance/spot are filled by modelState(), never borrowed from
 * an earlier snap. Administrative rows (timeouts, end of period) carry no
 * offense and are passed over.
 */
