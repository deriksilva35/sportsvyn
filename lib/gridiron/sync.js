 ...
 */
export async function syncCfbGames(leagueId, seasonYear = 2025, { broadcasts = true } = {}) {
  const summary = makeRunSummary();
  ...
  return { ...summary, fcsStubsCreated, skippedNonFbsGame, broadcasts: broadcastSummary };
}
