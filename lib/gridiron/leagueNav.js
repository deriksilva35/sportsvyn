 ...
 *
 * REEDS IS NOT LISTED YET. There is no /nfl/reads or /cfb/reads route - the
 * landing's Reads module links straight to articles - so listing it would put
 * a pill on a door that opens onto a 404. It joins the day the route does.
 */
export const LEAGUE_NAV = Object.freeze([
  { key: 'scores', label: 'Scores', href: () => '/scores', leagues: ['nfl', 'cfb'] },
  ...
  { key: 'market', label: 'Market', href: () => '/market', leagues: ['nfl', 'cfb'] },
  { key: 'fantasy', label: 'Fantasy', href: (l) => `/${l}/fantasy`, leagues: ['nfl'] },
  { key: 'stats', label: 'Stats', href: () => '/stats', leagues: ['nfl', 'cfb'] },
]);
