...
test('CFB: shipped App State override resolves to our "App State"', () => {
  const { byNorm, desc } = teamsFrom([['App State', 91], ['Georgia', 10]]);
  assert.equal(resolveTeamId('cfb', 'Appalachian State Mountaineers', byNorm, desc), 91);
});
