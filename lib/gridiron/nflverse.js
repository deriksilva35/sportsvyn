...
/** teams_colors_logos.csv - one row per team abbreviation incl. retired codes; CC-BY-4.0. */
export async function loadTeamColors(opts) {
  return parseCsv(await cached('teams_colors_logos.csv', `${BASE}/teams/teams_colors_logos.csv`, opts));
}
