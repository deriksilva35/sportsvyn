...
export async function getGamePage(slug) {
  ...
  return {
    ...
    home: { id: m.home_id, name: m.home_name, abbreviation: m.home_abbr, colors: teamColors(m.home_c1, m.home_c2) },
    away: { id: m.away_id, name: m.away_name, abbreviation: m.away_abbr, colors: teamColors(m.away_c1, m.away_c2) },
    events,
    lines,
