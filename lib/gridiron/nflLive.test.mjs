...
import { buildDriveChart, gamecastState, lastLivePlay, lastActionPlay, downDistanceLabel, spotLabel } from './driveStrip.js';
...
test('the last-play line reads the last PLAY, never a stoppage; the strip keeps the stoppage\'s situation', () => {
  ...
  assert.equal(lastLivePlay(stopped).playType, 'two-minute-warning', 'the strip still reads the situation off it');
