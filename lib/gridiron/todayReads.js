...
// LIVE LABEL MOVED TO lib/gridiron/liveLabel.js and is re-exported here, so
// every existing importer is untouched while a PURE module (slotState) can
// have the words without pulling this file's database reads in behind them.
export { liveLabelOf } from './liveLabel.js';
import { liveLabelOf } from './liveLabel.js';
