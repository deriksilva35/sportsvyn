...
export function toIdentity(p, teamByBdl) {
...
export async function upsertPlayers(rows) {
...
export async function nflTeamByBdl() {
...
// they simply have zero stat rows. Additive upsert - safe to run after syncNflSeason.
...
export async function syncNflSeason({ season = 2025, log = () => {} } = {}) {
