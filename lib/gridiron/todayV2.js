...
//
// THE TAB IS /nfl AND /cfb. lib/shell/appTabs.js:76 points the container's
// Today tab at /nfl, and activeTabFor lights it for /nfl, /cfb and /epl. The
// web header's TODAY is a different page at "/" and is not this.
//
...
import { getSlateByDate } from './readers.js';
...
export async function todayV2({ leagueSlug = 'nfl', userId = null, now = new Date() } = {}) {
  ...
  return {
    ...
    read, hero, picks, daily, teams, riding,
