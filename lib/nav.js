...
export const NAV = [
  ...
  // longer a bracket. It points at the schedule until the EPL surfaces land
  // (relay 2); /world-cup-2026/* still SERVES - the data and the routes stay,
  // they just stop being front doors.
  { key: 'soccer', label: 'SOCCER', href: '/schedule' },
];
