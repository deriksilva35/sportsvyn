...
//
// NOT ONE ROW OF MOVEMENT ANYWHERE. A test asserts no module renders a
// movement glyph while previous_rank is unwritten.
...
async function editionEntries(listSlug, { limit = null } = {}) {
  ...
  return limit == null ? shaped : shaped.slice(0, limit);
}
...
/** OUR TOP 25 for CFB - editorial, not the poll (R2). */
 ...
 */
export async function groupTable(leagueSlug, season, group) {
