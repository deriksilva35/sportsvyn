...
export function buildMagicLinkEmail({ url, identifier }) {
  ...
  const text =
    ...
    `If you didn't request this, ignore this email. This link expires ` +
    `shortly.\n\n` +
    `— Sportsvyn`;
      ...
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;width:100%;">
        ...
        <tr>
          <td style="padding-bottom:20px;color:#F5F5F2;font-size:15px;line-height:1.65;">
            Someone (we hope you) requested a sign-in link for ${identifier}. Click the button above to sign in.
          </td>
        </tr>
        <tr>
