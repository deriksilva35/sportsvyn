 ...
 */
export function shapeMlbMatch(row, slug, teamIdByBdl = new Map(), unmapped = {}) {
...
export async function writeMlbMatches(sql, leagueId, rows) {
    ...
    if (existing) {
      ...
      await sql`
        INSERT INTO matches (league_id, slug, home_team_id, away_team_id, kickoff_at, status,
                             home_score, away_score, season_year, season_phase, week, venue,
        ...
        VALUES (${leagueId}, ${g.slug}, ${g.homeTeamId}, ${g.awayTeamId}, ${g.kickoffAt}, ${g.status},
                ...
                ${g.seasonYear}, ${g.seasonPhase}, ${g.week}, ${g.venue},
