...
export async function runTopicDraft(promptText) {
  ...
  const draft = (await sql`
    INSERT INTO topic_drafts (
      ...
      ${wellFormed(promptText)}, ${plan.article_type ?? null},
