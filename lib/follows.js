...
/**
 * FIVE TEAMS PER LEAGUE (RANKINGS TAB v2, R4). Enforced in followTeam.
 *
 * IT LIVES HERE, NOT IN THE ACTION. app/actions/follows.js is a 'use server'
 * module and those may export ONLY async functions; a plain `export const`
 * there makes the bundler drop every export in the file and fails the
