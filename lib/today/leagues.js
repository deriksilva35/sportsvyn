...
export const TIER = Object.freeze({ GRIDIRON: 'gridiron', SOCCER: 'soccer', DIAMOND: 'diamond' });
...
export const LEAGUES = Object.freeze([
  ...
  // MLB JOINS WITH ITS BAND, not before it: a chip toggles a band, and a chip
  // registered without one is a control that visibly does nothing - which is
  // what the dead "MLB 2027" chip was. Its own tier, because the gridiron
  // preference rule below is a statement about football in autumn and MLB must
  // neither claim that preference nor be sorted by a rule written for soccer.
  { id: 'mlb', label: 'MLB', slug: 'mlb', defaultOn: true, tier: TIER.DIAMOND },
