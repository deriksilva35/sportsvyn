...
async function tonight(uid) {
  ...
  return rows.map((r) => {
    ...
    return {
      ...
      home: { name: r.home_short ?? r.home_name, shortName: r.home_short, abbreviation: r.home_abbr ?? null, colors: teamColors(r.home_c1, r.home_c2), score: r.home_score },
      away: { name: r.away_short ?? r.away_name, shortName: r.away_short, abbreviation: r.away_abbr ?? null, colors: teamColors(r.away_c1, r.away_c2), score: r.away_score },
