  ...
  async function pickemRow(sport, pickem) {
    ...
    if (pickem.settled) {
      const line1 = pickem.displayWeek != null
        ? `Board ${pickem.boardNumber} · ${SPORT} Week ${pickem.displayWeek} · settled`
        : `Board ${pickem.boardNumber} · ${SPORT} · settled`;
      return {
        line1, line2: pickem.record ? `${pickem.record.correct} of ${pickem.record.played}` : 'settled',
