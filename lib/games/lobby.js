...
export const GAME_META = {
  daily: {
    key: 'daily', leagues: ['nfl'], name: 'The Daily', href: '/daily', num: '01',
  ...
  pickem: {
    key: 'pickem', leagues: ['nfl', 'cfb'], name: 'Pick ’em', href: '/pickem', num: '02',
  ...
  weekly: {
    key: 'weekly', leagues: ['nfl'], name: 'The Weekly', href: '/weekly', num: '03',
  ...
  draft: {
    key: 'draft', leagues: ['nfl'], name: 'The Draft', href: '/draft', num: '04',
