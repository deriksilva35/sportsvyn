...
export const GAME_ORDER = ['daily', 'october', 'pickem', 'weekly', 'draft'];
...
export const GAME_NAMES = { daily: 'The Daily', october: 'October', pickem: "Pick'em", weekly: 'The Weekly', draft: 'The Draft' };
...
export const GAME_GLYPHS = { daily: '🗓', october: '⚾', pickem: '✅', weekly: '6️⃣', draft: '🪑' };
