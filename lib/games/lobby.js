...
export const GAME_META = {
  daily: {
    key: 'daily', name: 'The Daily', href: '/daily', num: '01',
  ...
  pickem: {
    key: 'pickem', name: 'Pick ’em', href: '/pickem', num: '02',
  ...
  weekly: {
    key: 'weekly', name: 'The Weekly', href: '/weekly', num: '03',
  ...
  draft: {
    key: 'draft', name: 'The Draft', href: '/draft', num: '04',
