...
test('EXACTLY THE NINE FIELDS, and a tenth does not get through', () => {
  // SIX BECAME NINE (LIVE ACTIVITY - THE LIVE LINE relay): possession,
  // situation and lastPlay joined the contract. redZone did not, and this is
  // the guard that keeps "no more" true by construction rather than by
  ...
  assert.deepEqual(s, { awayAbbr: 'IND', awayScore: 7, homeAbbr: 'KC', homeScore: 14,
    ...
    lastPlay: 'Mahomes pass complete' });
});
