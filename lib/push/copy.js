...
export const PUSH_COPY = {
  ...
  'run-open': {
    ...
    body: 'Set your nine - two arms, seven bats, from the clubs still alive. Locks at first pitch.',
    url: '/run',
  },
  'run-reminder': {
    title: 'One day to the round lock',
    body: '{n_set} of {of} set. The round locks at its first pitch.',
    url: '/run',
  },
  'run-settled': {
  ...
  'run-dnf': {
    title: 'The Run · DNF',
    body: 'Your nine were not set by first pitch, so {round} does not count. Best nine {best}.',
    url: '/run/board',
  },
  'october-dnf': {
    title: 'October · DNF',
