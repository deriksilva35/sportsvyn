...
/**
 * Pick 'em board open. THE CALLER DOES NOT EXIST YET - Pick 'em ships Aug 25
 * and its open path should call this with its board id the way daily-close
 * calls notifyDailyRevealed. Exported now so the copy, the gate and the
 * send-once key are already tested when that build lands.
 */
