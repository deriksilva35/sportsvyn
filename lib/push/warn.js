...
// skippedByPref: an audience existed and nobody in it wanted the event (a
// final_only subscriber on a score, say) - the silence SF-LAR's first field
// goal left in the ledger on 10 Sep.
const counts = { payloadNull: 0, audienceEmpty: 0, headlineNull: 0, dispatchSkip: 0, skippedByPref: 0 };
