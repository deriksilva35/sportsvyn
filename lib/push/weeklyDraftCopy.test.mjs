...
test('draft-settled substitutes pts, room_rank and the season rank (relay 2b item 1: room_rank is back)', () => {
  const c = renderCopy('draft-settled:3', { week: 1, pts: 61.4, room_rank: '2nd of 12', rank: 40, field: 214 });
  assert.equal(c.body, 'Week 1 is graded. 2nd of 12 in your room, 40 of 214.');
});
