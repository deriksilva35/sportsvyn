...
/**
 * THE SCALE, BEST FIRST. Exported since Mock Part B: the setup header's "best
 * grade" needs an ordering and there must not be a second list of these nine
 * letters anywhere - a scale that disagrees with itself between two screens is
 * worse than no scale.
 */
export const GRADE_ORDER = ['A', 'A-', 'B+', 'B', 'B-', 'C+', 'C', 'D', 'F'];
