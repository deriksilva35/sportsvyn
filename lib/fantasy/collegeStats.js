...
// breakout for everyone at once. Bumped deliberately - and deliberately a
// CONSTANT, where the NFL side no longer has one: playerStats.js takes its
// season from the caller now (the contest's, else the current REG season), so
