...
// THE SEASON A STAT LINE MEANS. On 2 Sep 2026 this is 2025 REG - the last
// completed season - and it stays 2025 REG until 2026 has weeks: the handoff
// is 2026 REG week 1 (games of Thu 10 Sep - Mon 14 Sep 2026), after which
// "last season" and "this season to date" become a policy choice, not a
// constant. Asking for 2026 today finds nothing (0 stat rows), so a blank PPG
// with these constants in place is NEVER a season problem - it is the identity
// join above (matched_player_id) going dark. Diagnosed 2 Sep 2026: the scoping
// was right all along; the Fantrax pool rows had simply never been matched.
