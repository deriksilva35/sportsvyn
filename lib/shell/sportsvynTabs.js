...
//
// FOUR TABS, and the order is the reading order of the app: home, what the
// scores are, what the drafters are doing, what the books are doing.
//
...
export const TABS = [
  // "TODAY" BECAME "HOME", v0.6. The app bar gained a Today tab of its own
  // pointing at /nfl, and two tabs sharing one label at two levels - going to
  // two different places - is a thing a reader has to learn for no reason.
  // This one points at "/", the Daily Card, and Home is what that is. The KEY
  // stays 'today' because it threads activeTab and the roots set, and an
  // identifier rename buys nothing anybody sees.
  { key: 'today', label: 'Home', href: '/' },
