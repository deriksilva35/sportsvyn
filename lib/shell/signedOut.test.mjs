...
const TABS = [
  ...
  // gamesLobby(userId took a second argument (relay 2c item 7's own
  // pickemSeasonSport) - the marker just needs to keep identifying THIS
  // call, not the exact old arity.
