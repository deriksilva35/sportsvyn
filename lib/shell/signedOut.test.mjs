...
const TABS = [
  ...
  // GAMES v3: the read is lobbyV3(userId, { chip, boardKey }) now. The law
  // is unchanged - the guard must precede the lobby read - and the marker
  // just has to keep identifying THAT call.
  { page: 'app/games/page.js', dest: '/games', hero: 'lobbyV3(userId,' },
